package com.covercorp.kaelaevent.minigame.games.colorgacha.arena.properties;
...
public final class ColorGachaMatchProperties {
    ...
    public ColorGachaMatchProperties(final ColorGachaArena arena) {
        startingTime = 5;
