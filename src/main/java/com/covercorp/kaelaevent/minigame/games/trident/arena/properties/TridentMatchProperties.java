package com.covercorp.kaelaevent.minigame.games.trident.arena.properties;
...
public final class TridentMatchProperties {
    ...
    private int tridentSpawnCooldown;

    public TridentMatchProperties(final TridentArena arena) {
        startingTime = 5;
