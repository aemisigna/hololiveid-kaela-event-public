package com.covercorp.kaelaevent.minigame.games.target.inventory;
...
public final class TargetItemCollection {
    ...
    public static final ItemStack BOW_ITEM = new ItemBuilder(Material.BOW)
            .withName("&aBow")
            .withNBTTag("accessor", "target_bow")
            .setUnbreakable()
            .hideEnchantments()
            .hideStats()
            .build();
    public static final ItemStack ARROW = new ItemBuilder(Material.ARROW).withNBTTag("accessor", "target_arrow").withName("&aArrow").build();


    public static void setupPlayerHotBar(final TargetPlayer gamePlayer) {
        ...
        final TargetTeam gameTeam = (TargetTeam) gamePlayer.getMiniGameTeam();
        if (gameTeam == null) {
        ...
        inventory.setItem(1, new ItemBuilder(ARROW).withAmount(3).build());
    ...
    public static void resetPlayerHotBar(final TargetPlayer gamePlayer) {
        final Player player = Bukkit.getPlayer(gamePlayer.getUniqueId());
