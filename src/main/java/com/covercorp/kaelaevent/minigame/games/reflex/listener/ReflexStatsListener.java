...
public final class ReflexStatsListener implements Listener {
    private final ReflexMiniGame miniGame;

    private final ReflexArena arena;

    public ReflexStatsListener(final ReflexMiniGame miniGame) {
    ...
    public void onPlayerDamage(final EntityDamageEvent event) {
        ...
        final Optional<ReflexPlayer> gamePlayerOptional = arena.getPlayerHelper().getPlayer(player.getUniqueId())
