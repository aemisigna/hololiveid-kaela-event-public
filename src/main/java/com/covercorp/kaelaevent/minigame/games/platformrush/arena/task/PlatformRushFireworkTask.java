...
public final class PlatformRushFireworkTask implements Runnable {
    private final PlatformRushArena arena;
    private final PlatformRushTeam winnerTeam;

    @Override
    public void run() {
        if (arena.getState() != PlatformRushMatchState.ENDING) {
            return;
        }
