package com.covercorp.kaelaevent.minigame.games.colorgacha.listener;
...
public final class ColorGachaStatsListener implements Listener {
    private final ColorGachaMiniGame miniGame;

    private final ColorGachaArena arena;

    public ColorGachaStatsListener(final ColorGachaMiniGame miniGame) {
