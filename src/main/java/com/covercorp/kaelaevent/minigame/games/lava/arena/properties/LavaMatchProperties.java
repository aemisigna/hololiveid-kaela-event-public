package com.covercorp.kaelaevent.minigame.games.lava.arena.properties;
...
public final class LavaMatchProperties {
    ...
    public LavaMatchProperties(final LavaArena arena) {
        startingTime = 5;
